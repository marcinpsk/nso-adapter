...
Pulls a real route-map off an IOS-XR device (prod-lab03d-ra1.lab) and applies it to sw01
(Junos crpd, PROD-LAB03-CRPD-SW01) through the REAL adapter ``run_apply`` atomic path
