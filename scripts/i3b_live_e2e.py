...
Isolated + revertible: a throwaway adapter device (mapped to NSO ``PROD-LAB03-CRPD-SW01``)
carries ONLY the greenfield ``ae99.999`` + ``33.1.1.1/24`` intent, so ``run_apply`` (with
