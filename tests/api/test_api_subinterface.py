...
"""M36: GET /api/v1/devices/{id}/subinterface + PUT /subinterface-intent."""
...
async def test_subinterface_returns_seeded_rows(adapter_client):
    ...
    await seed_subinterface(device_id, [
        {"interface_name": "GigabitEthernet0/1.100", "parent_interface": "GigabitEthernet0/1",
         "dot1q_vlan": 100, "type": "subinterface", "vrf": "TENANT_A"},
    ])
    ...
    assert resp.json() == {
        ...
        "interfaces": [
            {"interface_name": "GigabitEthernet0/1.100", "parent_interface": "GigabitEthernet0/1",
             "dot1q_vlan": 100, "type": "subinterface", "vrf": "TENANT_A", "source": "subinterface"}
        ],
    }
...
async def test_put_subinterface_intent_stores_and_full_replaces(adapter_client):
    ...
    body = {"interfaces": [
        {"interface_name": "GigabitEthernet0/1.100", "parent_interface": "GigabitEthernet0/1",
         "dot1q_vlan": 100, "type": "subinterface", "vrf": "MTI"},
        {"interface_name": "ge-0/0/0.200", "parent_interface": "ge-0/0/0", "dot1q_vlan": 200,
         "type": "subinterface"},
    ]}
    ...
    resp = await adapter_client.put(
        ...
        json={"interfaces": [{"interface_name": "ge-0/0/0.200", "parent_interface": "ge-0/0/0",
                              "dot1q_vlan": 200, "type": "subinterface"}]},
        headers=AUTH,
    )
...
async def test_put_subinterface_intent_unknown_device_404(adapter_client):
    resp = await adapter_client.put(
        "/api/v1/devices/999999/subinterface-intent", json={"interfaces": []}, headers=AUTH
    )
    assert resp.status_code == 404
