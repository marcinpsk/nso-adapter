...
Entry points:
- refresh_isis_interfaces_for_device() — called on-demand by scheduler / SSE coalescer
"""
    ...
    for proc in processes:
        ...
        db.add(
            DeviceIsisProcess(
                ...
                segment_routing_reported=proc.get("segment-routing-reported"),
                segment_routing_configured=proc.get("segment-routing-configured"),
                segment_routing=(proc.get("segment-routing") if "segment-routing" in proc else None),
